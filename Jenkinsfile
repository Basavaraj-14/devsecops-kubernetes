          ...
          steps {
            withAWS(credentials: 'jenkinscreds', region: 'ap-south-1'){
              sh '''
                ...
                docker tag devsecops:latest docker tag devsecops:latest 187868012081.dkr.ecr.ap-south-1.amazonaws.com/devsecops:latest
                187868012081.dkr.ecr.ap-south-1.amazonaws.com/devsecops:latest '''
            }
          }
        }
    }
